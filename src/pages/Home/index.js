    ...
    <>
      ...
      <footer className="row">
        <div className="col presta">
          ...
          {last && (
            <EventCard
              imageSrc={last?.cover} // Source de l'image de l'événement
              imageAlt={last?.description} // Texte alternatif pour l'image
              title={last?.title} // Titre de l'événement
              date={new Date(last?.date)} // Date de l'événement
              small // Indicateur pour un style de carte plus petit
              label={last?.type} // Type de l'événement
            />
          )}
        </div>
